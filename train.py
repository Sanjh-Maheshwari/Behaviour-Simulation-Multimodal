...
class SupervisedDataset(Dataset):
    ...
    def __getitem__(self, index) -> dict:
        ...
        text = f"##Instruction: {text} ##Question: How many likes must this tweet would have earned ? ##Answer: {answer}"
...
def main(config_file: str):
    ...
    test_dataset = filtered_df.sample(100)
    ...
    trainer = Trainer(
        ...
        train_dataset=SupervisedDataset(
            model_name, vision_model_name, train_dataset, max_length),
        eval_dataset=SupervisedDataset(
            model_name, vision_model_name, test_dataset, max_length),
        args=training_args,
    )
